...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fCheckMerkleRoot && hashMerkleRoot != BuildMerkleTree())
        return DoS(100, error("CheckBlock() : hash mismatch"));
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ETD", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "11/04/2014";
        CTransaction txNew;
        txNew.nTime = 1415150656;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1415150656;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 9278712;
		if(fTestNet)
        {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x61026877e1a264f93459de16695d9f3e7a880a4bbd9ba678cbe2a74efdb615c4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa4, 0xc1, 0xa2, 0xa1 };
