    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter an address (e.g. SyncfwYhBmGXcFP2Po1NpRUEiK8km2)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a address (e.g. SyncfwYhBmGXcFP2Po1NpRUEiK8km2)"));
